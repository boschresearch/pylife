...
# from pylife.materialdata.woehler.probability_curve_creator_options import ProbabilityCurveCreatorOptions
# from pylife.materialdata.woehler.probability_curve_diagrams_factory import ProbabilityCurveDiagramsFactory

# class ProbabilityCurvePlotter:
#     def __init__(self, probability_curve_creator_options):
#         self.probability_curve_diagrams_factory = ProbabilityCurveDiagramsFactory(probability_curve_creator_options.probability_curve)
#         if probability_curve_creator_options = 0: self.probability_curve_diagrams_factory.plot_probability_curve_diagram_finite()
#         elif probability_curve_creator_options = 1: self.probability_curve_diagrams_factory.plot_probability_curve_diagram_infinite()
#         else: raise AttributeError('Unexpected selection')
