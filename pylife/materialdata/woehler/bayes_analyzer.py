...
class BayesAnalyzer:
    ...
    def ld_lvl_sample(self, WoehlerCurve, data, n_N):
    ...
    def bayesian_slope(self, data_dict, model_name, samples, chains):
    ...
    def bayesian_slope_norm(self, data_dict, model_name, samples, chains):
    ...
    def bayesian_slope_plot(self, data_dict, burned_trace, slope_small, intercept_small, slope_full, intercept_full):
    ...
    def mali_sum_lolli(self, var, data_S, data_N, load_cycle_limit):
    ...
    def fail_runout_sampler(self, lvl, lvl_N_small, probability_runout, n_N_inf, n_frac):
    ...
    def ld_lvl_sample_inf(self, WoehlerCurve, n_N_inf):
