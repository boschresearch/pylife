...
class WoehlerCurveDiagrams:
    ...
    def plot_basic_fatigue_data(self, ax = None):
        ...
        ax_local.plot(self.woehler_curve.fatigue_data.runouts.cycles, self.woehler_curve.fatigue_data.runouts.loads, 'bo', mfc='none', label='Runout')   
        ax_local.plot(self.woehler_curve.fatigue_data.fractures.cycles, self.woehler_curve.fatigue_data.fractures.loads, 'bo', label='Failure')
