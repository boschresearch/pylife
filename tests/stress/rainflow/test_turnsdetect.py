...
from pylife.stress.rainflow.general import AbstractRainflowDetector
...
def test_rainflow_partial_get_turns_general():
    ...
    turns_tot = AbstractRainflowDetector(recorder=None)._get_new_turns(signal_tot)
    rfc_partial = AbstractRainflowDetector(recorder=None)
