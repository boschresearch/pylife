...
class LoadCollective(PylifeSignal, AbstractLoadCollective):
    ...
    def cycles(self):
        ...
        This is for compatibility with :class:`~pylife.stress.pylife.stress.MatrixLoadCollective`
        """
    ...
    def range_histogram(self, bins, axis=None):
        ...
        Returns
        -------
        range histogram : :class:`~pylife.pylife.stress.MatrixLoadCollective`
