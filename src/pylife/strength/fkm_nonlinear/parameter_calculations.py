# -*- coding: utf-8 -*-
"""
Created on Thu Jun  6 10:17:02 2019
...
def compute_beta(P_A):
    ...
    the lifetime assessment factor gamma_M. Note that the FKM nonlinear guideline
    does not list the formula for beta, they assume that the beta value is 
    known.
